...
def get_data_loaders(
    ...
    # Use ImageNet normalization to match pretrained backbone
...
def make_model(num_classes=10, dropout_p=0.3):
    # Fine-tune EfficientNet-B0, increase dropout slightly
...
def main():
    parser = argparse.ArgumentParser(description="Fashion-MNIST v3 Improved")
    ...
    model     = make_model(num_classes=10, dropout_p=0.3).to(device)
    ...
    with open('V3_metrics.csv', 'w') as metrics_file:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if val_acc > best_val_acc:
                ...
                torch.save(model.state_dict(), "best_v3_model.pth")
    ...
    torch.save(swa_model.module.state_dict(), "v3_swa_model.pth")
